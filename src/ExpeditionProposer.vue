...
const TYPE_LABELS: Record<number, string> = {
  ...
  17: '揚陸艦', 18: '装甲母', 19: '工作艦', 20: '潜母艦', 21: '練巡', 22: '補給艦',
}
...
const kcwebSnippet = `(async function() {
  ...
  const TYPE = {1:'DE',2:'DD',3:'CL',4:'CLT',5:'CA',6:'CAV',
                ...
                13:'SS',14:'SSV',15:'AO',16:'AV',17:'LHA',18:'CVB',19:'AR',20:'AS',21:'CT',22:'AO2'};
...
const TYPE_MAP: Record<string, number> = {
  ...
  AO: 15, AV: 16, LHA: 17, CVB: 18, AR: 19, AS: 20, CT: 21, AO2: 22,
}
...
// ── 艦種別グループ ──────────────────────────────────────────────────────────
const SHIP_TYPE_ORDER = [2, 3, 4, 5, 6, 7, 11, 18, 8, 9, 10, 13, 14, 16, 20, 1, 21, 15, 22, 17, 19]
